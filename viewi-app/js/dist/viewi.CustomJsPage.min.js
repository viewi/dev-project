(()=>{var O={componentsPath:"/assets/viewi.demo.json",publicPath:"/assets/",name:"demo",minify:!1,combine:!1,appendVersion:!1,build:"IR32ViPG",version:"2.0.0"};var J=window.ViewiApp?window.ViewiApp[O.name].register:{};var W=J.BaseComponent,pe=J.Layout,R=class extends W{_name="CustomJsPage";title="Custom JS page with lazy loading";markText=`some text 
