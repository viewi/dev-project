(() => {
  ...
  // app/CustomJsPage/components/CustomJsPage.js
...
`;
  ...
  // modules/CustomJsPage/index.ts
  CustomJsPage.prototype.getMarkedHtml = function() {
    return marked(this.markText);
  };

  // app/CustomJsPage/components/index.js
  var components = {
    CustomJsPage_x,
    CustomJsPage_t,
    CustomJsPage
